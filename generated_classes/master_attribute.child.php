...
require_once('baseclasses/master_attribute.php');

class masterAttributeChild extends master_attribute
{ 	// class : begin
...
function masterAttributeChild()
{
$this->master_attribute();
}
...
$query = "SELECT $this->selectColumn FROM master_attribute WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO master_attribute (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
