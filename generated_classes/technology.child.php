...
require_once('baseclasses/technology.php');

class technologyChild extends technology
{ 	// class : begin
...
$query = "SELECT $this->selectColumn FROM technology WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO technology (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
