...
require_once('baseclasses/product_attribute_value.php');

class productAttributeValueChild extends product_attribute_value
{ 	// class : begin
...
function productAttributeValueChild()
{
$this->product_attribute_value();
}
...
$query = "SELECT $this->selectColumn FROM product_attribute_value WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO product_attribute_value (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
