...
require_once('baseclasses/product_attribute.php');

class productAttributeChild extends product_attribute
{ 	// class : begin
...
function productAttributeChild()
{
...
$query = "SELECT $this->selectColumn FROM product_attribute WHERE ";
$condition= $this->condition;
$param = $this->param;
	if (is_array($condition)) 
	{
...
$this->id = "" ;
	try
	{
		...
		$sql = $this->conn->prepare("INSERT INTO product_attribute (" . implode(", ", $columnNames) . ") VALUES " . implode(", ", $rowsSQL));
